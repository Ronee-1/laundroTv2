/**
 * Daily Summary API for Spoke
 * GET /api/branches/:id/daily-summary
 *
 * Revenue data is sourced from cashbook entries (Tunai) and orders (Non-Tunai)
 * This endpoint provides real-time revenue data per branch
 */
